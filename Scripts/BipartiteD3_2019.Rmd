...
ForPlot%>%
  ...
  bipartite_D3(filename = 'LargeSeedPredatorNetwork',
               PrimaryLab = 'Seed',SortPrimary = PlantPos, SortSecondary = PredPos,
               SecondaryLab = 'Seed Predator',MainFigSize = c(1000, 6100),
               IndivFigSize = c(150, 6000))-> intweb

r2d3::save_d3_html(intweb, file = '../Figures/SeedPredatorWeb.html')
